...
const translations = {
  en: {
    ...
    chat: {
      ...
      close: "Close",
      minimize: "Minimize",
      expand: "Open the chat",
      typing: "typing…",
      chooseStyle: "Choose a style",
      greeting: "👋 Hello! How can I help you? Ask about prices, delivery, deadlines or products.",
      errorRate: "Too many messages — please try again a bit later.",
      errorBlocked: "Your account is blocked — please contact us.",
      errorGeneric: "Something went wrong. Please try again, or contact us: +(995 32) 2 05 06 20 / 599 05 08 07.",
    },
    notFound: {
  ...
  ge: {
    ...
    chat: {
      ...
      expand: "ჩატის გახსნა",
      typing: "წერს…",
      chooseStyle: "აირჩიე სტილი",
      greeting: "👋 გამარჯობა! რით შემიძლია დაგეხმაროთ? იკითხეთ ფასები, მიწოდება, ვადები ან პროდუქცია.",
      errorRate: "ბევრი შეტყობინება — სცადეთ ცოტა ხანში.",
      errorBlocked: "ანგარიში დაბლოკილია — დაგვიკავშირდით.",
      errorGeneric: "რაღაც შეფერხდა. სცადეთ ხელახლა, ან დაგვიკავშირდით: +(995 32) 2 05 06 20 / 599 05 08 07.",
    },
    notFound: {
