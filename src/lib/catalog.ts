...
const KNOWN_IMAGES: Record<string, string> = {
  ...
  "Hoodie|JEL Zipper|White|front": "/products/hoodie/JEL zipper black front.png",
  "Hoodie|JEL Zipper|White|back": "/products/hoodie/JEL zipper black back.png",
  ...
  "Tote Bag|Tote Bag|White|back": "/products/totebag/TOTE BAG.png",
};
