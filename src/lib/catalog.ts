...
const KNOWN_IMAGES: Record<string, string> = {
  ...
  "Hoodie|JEL Hoodie|Light Gray|front": "/products/hoodie/მობ. ნაცრისფერი პუდი წინ.png",
  "Hoodie|JEL Hoodie|Light Gray|back": "/products/hoodie/მობ. ნაცრისფერი პუდი უკან.png",
  "Hoodie|JEL Hoodie|Black|front": "/products/hoodie/მობ. შავი პუდი წინ.png",
  "Hoodie|JEL Hoodie|Black|back": "/products/hoodie/მობ. შავი პუდი უკან.png",
  "Hoodie|JEL Hoodie|Khaki|front": "/products/hoodie/მობ. ხაკისფერი პუდი წინ.png",
  "Hoodie|JEL Hoodie|Khaki|back": "/products/hoodie/მობ. ხაკისფერი პუდი უკან.png",
