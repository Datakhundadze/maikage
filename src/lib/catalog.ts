...
const KNOWN_IMAGES: Record<string, string> = {
  ...
  "Hoodie|JEL Zipper|Dark Navy|back": "/products/hoodie/jel-zipper-navy-back.png",
  "Hoodie|JEL Zipper|Gray|front": "/products/hoodie/jel-zipper-gray-front.png",
  "Hoodie|JEL Zipper|Gray|back": "/products/hoodie/jel-zipper-gray-back.png",
