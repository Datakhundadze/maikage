        ...
        <div className="space-y-4">
            ...
            >
              {personImage ? (
                <div className="relative">
                  <img src={personImage} alt="Person" className="w-full max-h-64 object-contain rounded-xl" loading="eager" />
                  <button
          ...
          {resultImage && (
            <div className="relative rounded-xl overflow-hidden border border-border">
              <img src={resultImage} alt="Try-on result" className="w-full object-contain" loading="eager" fetchPriority="high" />
