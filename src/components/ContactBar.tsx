    ...
    <div className="flex items-center justify-end px-4 py-1 bg-sidebar border-b border-sidebar-border text-sidebar-foreground/70 text-[11px] shrink-0 gap-3">
      ...
      <Tooltip delayDuration={100}>
        <TooltipTrigger asChild>
          <a href="tel:+995322050620" className="hover:text-sidebar-foreground transition-colors">
      ...
      <Tooltip delayDuration={100}>
        <TooltipTrigger asChild>
          <a href="https://wa.me/995599050807" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">
            <Smartphone className="h-3.5 w-3.5" />
          </a>
        </TooltipTrigger>
        <TooltipContent side="bottom" className="text-xs">
          📱 599 05 08 07 (WhatsApp)
        </TooltipContent>
      </Tooltip>

      <Tooltip delayDuration={100}>
        <TooltipTrigger asChild>
          <a href="mailto:maika@maika.ge" className="hover:text-sidebar-foreground transition-colors">
