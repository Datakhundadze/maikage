    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-between px-4 sm:px-6 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <a href="https://www.google.com/maps/place/Maika.ge/@41.7231446,44.7910174,17z" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-red-500 transition-colors" aria-label="ლოკაცია Google Maps-ზე">
