  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen px-4 py-12 sm:py-20">
        ...
        {/* Footer / Contact */}
        <div className="mt-auto flex flex-col items-center gap-4 text-white/30 text-sm">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
            <a href="mailto:maika@maika.ge" className="inline-flex items-center gap-2 hover:text-white/60 transition-colors">
          ...
          <p className="text-xs text-white/20 mt-2">© 2025 maika.ge</p>
        </div>
      </div>
    </div>
  );
